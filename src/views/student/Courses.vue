        ...
        <v-row justify="center">
            <v-card class="ma-3" max-width="344" v-for="course in coursesList" :key="course.id_c">
                <v-img src="https://cdn.vuetifyjs.com/images/cards/sunshine.jpg" height="200px"
                    ...
                    <v-card-subtitle class="white--text"><b>Professor: </b>{{ course.p_name }}</v-card-subtitle>
                </v-img>
                <v-card-text>
                ...
                <v-card-actions>
                    <v-btn color="purple" dark absolute right @click="joinIn(course.id_c)">Entrar</v-btn>
                </v-card-actions>
            </v-card>
        </v-row>
    </v-container>
